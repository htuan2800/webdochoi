...
function watchStatistics() {
    ...
    if (selectTimeElement.value === "1") { // Theo tháng
        headerRow.innerHTML = `
            ...
            <th class="text-center align-middle">Lợi nhuận</th>
        `;
    } else { // Theo năm
        headerRow.innerHTML = `
            ...
            try {
                data.chart_data.forEach(item => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="text-center">${Number(item.total_bill).toLocaleString('vi-VN')} đ</td>
                        <td class="text-center">${Number(item.total_import).toLocaleString('vi-VN')} đ</td>
                        <td class="text-center">${Number(item.total_profit).toLocaleString('vi-VN')} đ</td>
                    `;
                ...
                const end = document.createElement('tr');
                    ...
                    <td class="text-center">${data.totalBills.toLocaleString('vi-VN')} đ</td>
                    <td class="text-center">${data.totalImports.toLocaleString('vi-VN')} đ</td>
                    <td class="text-center">${data.totalProfits.toLocaleString('vi-VN')} đ</td>
                `;
...
function exportToPDF() {
    ...
    title.innerHTML = `BÁO CÁO LỢI NHUẬN`;
